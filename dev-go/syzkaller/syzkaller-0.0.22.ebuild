...
CROS_GO_SOURCE="github.com/google/syzkaller 59da83662ae7076f1369c8a5b9dd1245223039df"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/0010-cros-syzkaller-log-canonicalizer-info.patch
	eapply "${FILESDIR}"/0012-cros-syzkaller-do-not-collect-remote-coverage.patch
