...
CROS_WORKON_COMMIT="a262635109ab4b5e5fd4ee69d8f4c869467c20ea"
CROS_WORKON_TREE="3f7c25bf2c515ce1ecad2eb8d42bd5ae0af83acc"
...
SLOT="0"
KEYWORDS="*"
IUSE="arc-camera3 biod -chromeless_tests -chromeless_tty +crash_reporting cups +encrypted_stateful lvm_stateful_partition +network_time +passive_metrics +profile vaapi"
...
# TODO(b/290823172) Remove firmware_LockedME below when the test is no longer
# in any PVS plan
CLIENT_IUSE_TESTS="
	+tests_profiler_sync
	+tests_crashme
	...
	encrypted_stateful? ( !lvm_stateful_partition? ( +tests_platform_EncryptedStateful ) )
