...
PATCHES=(
	...
	"${FILESDIR}/GITHUB-PR1797-Make_genrand_int32_thread_safe.patch"
)
...
src_install() {
	...
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_ext_cxx_for_opencl/test_cl_ext_cxx_for_opencl"
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_khr_command_buffer/cl_khr_command_buffer_mutable_dispatch/test_cl_khr_mutable_dispatch"
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_khr_command_buffer/test_cl_khr_command_buffer"
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_khr_semaphore/test_cl_khr_semaphore"
