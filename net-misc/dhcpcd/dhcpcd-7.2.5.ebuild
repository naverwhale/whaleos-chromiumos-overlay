...
src_prepare()
{
	...
	eapply "${FILESDIR}"/patches/${P}-Apply-DSCP-on-egress-packets.patch
	eapply "${FILESDIR}"/patches/${P}-Do-not-force-message-came-from-port-67.patch
	eapply "${FILESDIR}"/patches/${P}-Add-DHCP-option-114-captive_portal_uri.patch
