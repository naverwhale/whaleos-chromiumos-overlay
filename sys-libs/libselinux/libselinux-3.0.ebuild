...
inherit multilib python-r1 toolchain-funcs multilib-minimal flag-o-matic
...
PATCHES=(
	"${FILESDIR}/0001-libselinux-Add-CPPFLAGS-to-Makefile.patch"
)
...
multilib_src_compile() {
	...
	# See also https://github.com/SELinuxProject/selinux/issues/366
	append-lfs-flags
