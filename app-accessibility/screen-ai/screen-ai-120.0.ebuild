...
SRC_URI="
	arm? ( gs://chromeos-localmirror/distfiles/${PN}-arm32-${PV}.tar.xz )
	arm64? ( gs://chromeos-localmirror/distfiles/${PN}-arm64-${PV}.tar.xz )
	amd64? ( gs://chromeos-localmirror/distfiles/${PN}-amd64-${PV}.tar.xz )
"
...
src_install() {
	...
	doins \
		taser_tflite_gocrlatinconvnext320_mbv2_scriptid_aksara_layout_gro_mobile_engine.binarypb
	doins \
	...
	doins \
		taser_tflite_gocrlatinconvnext320_mbv2_scriptid_aksara_layout_gro_mobile_runner.binarypb
	doins \
		taser_tflite_gocrlatinconvnext320_mbv2_scriptid_aksara_layout_gro_mobile_runner_ti.binarypb
	insinto "$(dlc_add_path /aksara)"
	doins \
		aksara/aksara_page_layout_analysis_rpn_gro.binarypb
	doins \
