...
PATCHES=(
	"${FILESDIR}"/CHROMIUM-mount-no-canonicalize.patch # b/194944898: downstream patch
	"${FILESDIR}"/CHROMIUM-nsenter-nofollow.patch # b/226186172: downstream patch
	"${FILESDIR}"/CHROMIUM-umount-no-canonicalize.patch # b/226186168: downstream patch
	"${FILESDIR}"/CHROMIUM-fincore-support-device-files.patch  # b/290167919: patch sent upstream.
)
