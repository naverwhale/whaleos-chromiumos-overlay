...
inherit cros-constants flag-o-matic python-any-r1
...
src_prepare() {
	...
	# Patch for b/290833009
	eapply "${FILESDIR}/gcc-Fix-locale-header.patch"
}
...
src_compile() {
	...
	# The GCC we build uses the `register` keyword, which upsets Clang when
